...
function addProgressBarToDocument(): HTMLDivElement {
  ...
  progressBar.classList.add('progress-ring');
  progressBar.innerHTML = /* HTML */ `
    <div class="fixed inset-0 z-20 bg-black bg-opacity-70">
      <div
        class="fixed inset-0 m-auto flex h-fit w-fit  items-center justify-center rounded-md bg-white p-4 shadow-md"
      >
        <svg
          aria-hidden="true"
